...
function (window) {
    ...
    window.opspark.makeGame = function() {
        ...
        var circle; 
//undefined variable that will hold an individual circle

        var circles = []; 
//empty array that will later hold multiple circles
        ...
        function drawCircle(){
            ...
            circle = draw.randomCircleInArea(canvas, true, true, '#999', 2); //calls the random circle function, creates a circle, stores it in the circle variable
        ...
        //manually, repetitively drew circles each time function was called
